...
public class JoinOrderFragment extends BaseFragment implements BaseAdapter.OnItemClickListener {
    ...
    public static JoinOrderFragment newInstance() {
        return new JoinOrderFragment();
    }


    @Override
    protected int getLayoutResId() {
        return R.layout.join_order_fragment;
    }
